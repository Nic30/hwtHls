//===- CodeGenPrepare.cpp llvm-21.1.2 - Prepare a function for code generation --------===//
//
...
static cl::opt<bool>
    DisableSelectToBranch("hwtHls-disable-cgp-select2branch", cl::Hidden,
                          cl::init(false),
                          cl::desc("Disable select to branch conversion."));

static cl::opt<bool>
    AddrSinkUsingGEPs("hwtHls-addr-sink-using-gep", cl::Hidden, cl::init(true),
                      cl::desc("Address sinking in CGP using GEPs."));

static cl::opt<bool>
    EnableAndCmpSinking("hwtHls-enable-andcmp-sinking", cl::Hidden, cl::init(true),
...
static cl::opt<bool> EnableTypePromotionMerge(
    "hwtHls-cgp-type-promotion-merge", cl::Hidden,
...
static cl::opt<bool> AddrSinkNewSelects(
    "hwtHls-addr-sink-new-select", cl::Hidden, cl::init(true),
...
static cl::opt<bool>
    OptimizePhiTypes("hwtHls-cgp-optimize-phi-types", cl::Hidden, cl::init(true),
...
static cl::opt<unsigned>
    MaxAddressUsersToScan("hwtHls-cgp-max-address-users-to-scan", cl::init(100),
                          cl::Hidden,
                          cl::desc("Max number of address users to look at"));

static cl::opt<bool>
    DisableDeletePHIs("hwtHls-disable-cgp-delete-phis", cl::Hidden, cl::init(false),
