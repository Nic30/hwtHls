...
CodeExtractor::CodeExtractor(ArrayRef<BasicBlock *> BBs, DominatorTree *DT,
    ...
    : DT(DT), AggregateArgs(AggregateArgs || AggregateArgsOpt), BFI(BFI),
	  ...
	  RetTy(nullptr), Suffix(Suffix), ArgsInZeroAddressSpace(ArgsInZeroAddressSpace) {}
...
CodeExtractor::CodeExtractor(DominatorTree &DT, Loop &L, bool AggregateArgs,
    ...
    : DT(&DT), AggregateArgs(AggregateArgs || AggregateArgsOpt), BFI(BFI),
      ...
      Blocks(buildExtractionBlockSet(L.getBlocks(), &DT,
                                     /* AllowVarArgs */ false,
                                     /* AllowAlloca */ false)),
									 RetTy(nullptr), Suffix(Suffix), ArgsInZeroAddressSpace(false) {}
...
void CodeExtractor::constructFunctionInheritAttributes(Function * oldFunction, Function * newFunction) {
...
void eraseLifetimeMarkersOnInputs(const SetVector<BasicBlock *> &Blocks,
...
void fixupDebugInfoPostExtraction(Function &OldFunc, Function &NewFunc,
                                         CallInst &TheCall) {
