//===- BranchFolding.cpp llvm-21.1.2 - Fold machine code branch instructions ----------===//
//
...
#define DEBUG_TYPE "hwthls-branch-folder"
...
static cl::opt<cl::boolOrDefault> FlagEnableTailMerge("hwthls-enable-tail-merge",
                              cl::init(cl::BOU_UNSET), cl::Hidden);

// Throttle for huge numbers of predecessors (compile speed problems)
static cl::opt<unsigned>
TailMergeThreshold("hwthls-tail-merge-threshold",
          cl::desc("Max number of predecessors to consider tail merging"),
          cl::init(150), cl::Hidden);

// Heuristic for tail merging (and, inversely, tail duplication).
static cl::opt<unsigned>
TailMergeSize("hwthls-tail-merge-size",
