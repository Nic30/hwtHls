...
public:
	...
	using SliceDict = std::map<std::pair<llvm::Value*, uint64_t>, std::vector<llvm::CallInst*>>;

protected:
	llvm::SmallSetVector<llvm::Instruction*, 16> WorkList; // main worklist containing instructions which may be dead
