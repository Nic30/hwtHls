...
//bool GenFpgaCombinerHelper::matchMuxWithRedundantCases(MachineInstr &MI,
...
//}
//
//bool GenFpgaCombinerHelper::rewriteMuxWithRedundantCases(MachineInstr &MI,
//		const SmallVector<unsigned> &uselessConditions) {
//	assert(MI.getOpcode() == GenericFpga::GENFPGA_MUX);
//
//}

bool GenFpgaCombinerHelper::hashSomeConstConditions(MachineInstr &MI) {
	// dst, a, (cond, b)*
	assert(MI.getOpcode() == GenericFpga::GENFPGA_MUX);
...
bool GenFpgaCombinerHelper::rewriteConstCondMux(MachineInstr &MI) {
	assert(MI.getOpcode() == GenericFpga::GENFPGA_MUX);
 ...
 *
 */
bool GenFpgaCombinerHelper::matchNestedMux(MachineInstr &MI,
...
bool GenFpgaCombinerHelper::rewriteNestedMuxToMux(MachineInstr &MI,
...
bool GenFpgaCombinerHelper::hasAll1AndAll0Values(MachineInstr &MI,
...
bool GenFpgaCombinerHelper::rewriteConstValMux(MachineInstr &MI,
