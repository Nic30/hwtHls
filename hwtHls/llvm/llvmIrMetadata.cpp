...
void register_MDNode(pybind11::module_ & m) {
	...
	Metadata
		.def("asMetadata", &asMetadata<llvm::Metadata>)
	...
	MDNode
		...
		.def("asMetadata", &asMetadata<MDNodeWithDeletedDelete>, py::return_value_policy::reference)
	...
	MDTuple
		.def("asMetadata", &asMetadata<MDTupleWithDeletedDelete>)
	...
	ValueAsMetadata
		.def_static("get", llvm::ValueAsMetadata::get)
	...
	ConstantAsMetadata
		.def("asMetadata", &asMetadata<llvm::ConstantAsMetadata>, py::return_value_policy::reference)
		.def("__repr__", &printToStr<llvm::ConstantAsMetadata>);

	ValueAsMetadata
		.def("asMetadata", &asMetadata<llvm::ValueAsMetadata>, py::return_value_policy::reference)
		.def_static("getConstant", &llvm::ValueAsMetadata::getConstant, py::return_value_policy::reference);
	...
	py::class_<llvm::MDString, std::unique_ptr<llvm::MDString, py::nodelete>, llvm::Metadata>(m, "MDString")
		...
		.def("asMetadata", &asMetadata<llvm::MDString>, py::return_value_policy::reference)
