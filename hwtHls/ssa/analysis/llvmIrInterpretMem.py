...
from hwtHls.llvm.llvmIr import Instruction, BasicBlock, InstructionToGetElementPtrInst, \
    TypeToArrayType, InstructionToFreezeInst, InstructionToAllocaInst, TypeToIntegerType, \
    ValueToAllocaInst, AllocaInst, Value, ArrayType
...
def _decodeOpcode_Freeze(interpret: "LlvmIrInterpret", bb: BasicBlock, instr: Instruction) -> LlvmIrInstrFunction:
...
def _decodeOpcode_GetElementPtr(interpret: "LlvmIrInterpret", bb: BasicBlock, instr: Instruction) -> LlvmIrInstrFunction:
