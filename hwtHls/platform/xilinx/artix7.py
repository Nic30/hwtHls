...
from hwt.serializer.resourceAnalyzer.resourceTypes import ResourceFF, RtlResourceType,\
    ResourceRAM
from hwtHls.code import OP_ASHR, OP_LSHR, OP_SHL, \
    OP_FSHL, OP_FSHR, OP_ROL, OP_ROR
from hwtHls.platform.interpolations import Spline, \
    ResourceSplineBundleBitwidthDependent, ResourceSplineBundleArgCntDependent
...
class Artix7Slow(AbstractXilinxPlatform):
    ...
    def _init_coefs(self):
        AddSubnS = ResourceSplineBundleBitwidthDependent(Spline(
        ...
        Cmp = ResourceSplineBundleBitwidthDependent(Spline(
        ...
        LogicGate = ResourceSplineBundleBitwidthDependent(Spline(
        ...
        MulnS = ResourceSplineBundleBitwidthDependent(Spline(
        ...
        MuxnS = ResourceSplineBundleArgCntDependent(Spline(
        ...
        Sel = ResourceSplineBundleBitwidthDependent(Spline(
