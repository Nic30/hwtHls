...
; predecessors: %bb.0, %bb.1
  ...
  %19:anyregcls(s1) = G_ICMP intpred(ule), %14:anyregcls(s16), %17:anyregcls
  ...
  %25:anyregcls(s1) = G_ICMP intpred(ule), %20:anyregcls(s16), %23:anyregcls
  GENFPGA_CSTORE %25:anyregcls(s1), %8:anyregcls, 0, 1 :: (volatile store (s1) into %ir.res_prefix_same_1, addrspace 8)
  %26:anyregcls(s1) = G_ICMP intpred(ule), %14:anyregcls(s16), %23:anyregcls
  ...
  %30:anyregcls(s1) = G_ICMP intpred(ule), %14:anyregcls(s16), %27:anyregcls
  ...
  %45:anyregcls(s1) = G_ICMP intpred(ule), %37:anyregcls(s16), %43:anyregcls
  ...
  %48:anyregcls(s1) = G_ICMP intpred(ule), %37:anyregcls(s16), %46:anyregcls
