# Machine code for function forkedTriangleWhichIsLoopInLoop1: IsSSA, TracksLiveness, Legalized, RegBankSelected, Selected
...
; predecessors: %bb.1, %bb.2
  ...
  %12:anyregcls(s1) = G_XOR killed %3:anyregcls, killed %13:anyregcls
  %5:anyregcls(s1) = HWTFPGA_CLOAD %0:anyregcls, 0, 1, %12:anyregcls(s1) :: (volatile load (s1) from %ir.iC0, addrspace 1)
  HWTFPGA_CSTORE i8 2, %1:anyregcls, 0, 8, %12:anyregcls(s1) :: (volatile store (s8) into %ir.o, addrspace 2)
  %15:anyregcls(s1) = G_CONSTANT i1 true
  %14:anyregcls(s1) = G_XOR killed %5:anyregcls, killed %15:anyregcls
  %16:anyregcls(s1) = G_AND killed %12:anyregcls, killed %14:anyregcls
  ...
  %9:anyregcls(s1) = HWTFPGA_CLOAD %0:anyregcls, 0, 1, 1 :: (volatile load (s1) from %ir.iC0, addrspace 1)
  G_BRCOND killed %9:anyregcls(s1), %bb.1
  G_BR %bb.2

# End machine code for function forkedTriangleWhichIsLoopInLoop1.
