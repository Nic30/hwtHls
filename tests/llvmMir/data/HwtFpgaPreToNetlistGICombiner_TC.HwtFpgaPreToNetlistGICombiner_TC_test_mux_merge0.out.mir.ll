...
; predecessors: %bb.1, %bb.2
  ...
  %79:anyregcls(s27) = HWTFPGA_MERGE_VALUES %44:anyregcls(s16), %8:anyregcls(s8), %5:anyregcls(s2), i1 true, 16, 8, 2, 1
  %80:anyregcls(s16) = HWTFPGA_IMPLICIT_DEF 16
  %18:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %12:anyregcls(s5), i5 8
  %81:anyregcls(s27) = HWTFPGA_MERGE_VALUES %8:anyregcls(s8), undef %28:anyregcls(s16), i3 1, 8, 16, 3
  %82:anyregcls(s16) = HWTFPGA_MERGE_VALUES %8:anyregcls(s8), undef %24:anyregcls(s8), 8, 8
  ...
  %65:anyregcls(s27) = HWTFPGA_MUX %60:anyregcls(s27), %18:anyregcls(s1), killed %81:anyregcls(s27)
  %66:anyregcls(s16) = HWTFPGA_MUX %25:anyregcls(s16), %18:anyregcls(s1), %82:anyregcls(s16)
  %83:anyregcls(s16) = HWTFPGA_MUX %25:anyregcls(s16), %18:anyregcls(s1), killed %82:anyregcls(s16)
  %45:anyregcls(s27) = HWTFPGA_MUX killed %79:anyregcls(s27), %16:anyregcls(s1), %65:anyregcls(s27)
  %46:anyregcls(s16) = HWTFPGA_MUX killed %80:anyregcls(s16), %16:anyregcls(s1), %66:anyregcls(s16)
  ...
  %49:anyregcls(s16) = HWTFPGA_MUX killed %83:anyregcls(s16), %71:anyregcls(s1), %46:anyregcls(s16)
