...
if __name__ == '__main__':
    ...
    # suite = unittest.TestSuite([Axi4SSParseIf_1Seg_TC("test_Axi4SParse2IfAndSequel_NO_FOOTER_16b_100MHz")])
    suite = testLoader.loadTestsFromTestCase(Axi4SSParseIf_1Seg_TC)
