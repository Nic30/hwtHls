...
class HlsNetlistReduceCmpInAndTC(unittest.TestCase):
    ...
    def test_reduceRangesToEq(self):
        ...
        e0 = b.buildOp(AllOps.ULE, BIT, r0, b.buildConstPy(uint8_t, 10))
        e1 = b.buildOp(AllOps.UGE, BIT, r0, b.buildConstPy(uint8_t, 10))
        res = b.buildAnd(
            e0,
            e1,
        )
    ...
    def test_reduceLtGtTo0(self):
        ...
        e0 = b.buildOp(AllOps.ULT, BIT, r0, b.buildConstPy(uint8_t, 10))
        e1 = b.buildOp(AllOps.UGT, BIT, r0, b.buildConstPy(uint8_t, 10))
        res = b.buildAnd(
            e0,
            e1,
        )
    ...
    def test_reduceNeLtToNe(self):
        ...
        e0 = b.buildOp(AllOps.ULE, BIT, r0, b.buildConstPy(uint8_t, 255))
