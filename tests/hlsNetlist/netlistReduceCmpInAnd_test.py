...
class HlsNetlistReduceCmpInAndTC(unittest.TestCase):
    ...
    def _r(self, netlist: HlsNetlistCtx, dtype=uint8_t):
    ...
    #    r0 = self._r(netlist)
    #
    #    e0 = b.buildOp(HwtOps.ULE, BIT, r0, b.buildConstPy(uint8_t, 10))
    #    e1 = b.buildOp(HwtOps.UGE, BIT, r0, b.buildConstPy(uint8_t, 10))
    #    res = b.buildAnd(
    #        e0,
    #        e1,
    #    )
    ...
    #    r0 = self._r(netlist)
    #
    #    e0 = b.buildOp(HwtOps.ULT, BIT, r0, b.buildConstPy(uint8_t, 10))
    #    e1 = b.buildOp(HwtOps.UGT, BIT, r0, b.buildConstPy(uint8_t, 10))
    #    res = b.buildAnd(
    #        e0,
    #        e1,
    #    )
    ...
    #    r0 = self._r(netlist)
    #
    #    e0 = b.buildOp(HwtOps.ULE, BIT, r0, b.buildConstPy(uint8_t, 255))
