...
nodes:
    <HlsNetNodeOutLazy 0>
    <HlsNetNodeConst 4 <BitsVal 0>>
    <HlsNetNodeWrite 5 <Signal o <Bits, 8bits, unsigned>> <- <HlsNetNodeOut <BitsVal 0> [0]>>
...
nodes:
    <HlsNetNodeOutLazy 0>
    <HlsNetNodeConst 8 <BitsVal 2>>
    <HlsNetNodeWrite 9 <Signal o <Bits, 8bits, unsigned>> <- <HlsNetNodeOut <BitsVal 2> [0]>>
