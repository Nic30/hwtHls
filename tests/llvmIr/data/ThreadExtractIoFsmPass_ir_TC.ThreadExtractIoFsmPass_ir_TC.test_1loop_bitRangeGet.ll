...
define void @ThreadExtractIoFsmPass_ir_TC.test_1loop_bitRangeGet(ptr addrspace(1) %rx, ptr addrspace(2) %0) !prof !0 !hwtHls.io !1 {
bb0:
...
define void @ThreadExtractIoFsmPass_ir_TC.test_1loop_bitRangeGet.ioFsmExtract.tx(ptr addrspace(1) %tx, ptr addrspace(2) %0) !prof !0 !hwtHls.io !7 {
bb0:
  br label %bb.loop.head

bb.loop.head:                                     ; preds = %bb.loop.head, %bb0
  %r0 = load i37, ptr addrspace(2) %0, align 8
  %v = call i8 @hwtHls.bitRangeGet.i37.i6.i8.0(i37 %r0, i6 0)
  store volatile i8 %v, ptr addrspace(1) %tx, align 8
  br label %bb.loop.head
}
...
!5 = !{!"OUT", i64 0, i64 1, i64 37, ptr @ThreadExtractIoFsmPass_ir_TC.test_1loop_bitRangeGet.ioFsmExtract.tx, i64 1, !6}
!6 = !{!"hwtHls.io.buffercapacity", i64 1}
!7 = distinct !{!8, !9}
!8 = !{!"OUT", i64 0, i64 37, i64 37, ptr null, i64 1, !3}
!9 = !{!"IN", i64 0, i64 1, i64 37, ptr @ThreadExtractIoFsmPass_ir_TC.test_1loop_bitRangeGet, i64 1}
