define void @test_constFold_Xor(ptr addrspace(1) %i0, ptr addrspace(1) %i1, ptr addrspace(2) %o0, ptr addrspace(2) %o1) {
  ...
  store volatile i4 3, ptr addrspace(2) %o1, align 1
  ret void
}
