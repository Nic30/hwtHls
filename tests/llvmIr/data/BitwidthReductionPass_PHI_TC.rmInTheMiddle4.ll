...
BB1:                                              ; preds = %BB0
  ...
  %rxData1 = call i8 @hwtHls.bitRangeGet.i19.i6.i8.8(i19 %rxRaw, i6 8) #1
...
BBend:                                            ; preds = %BBv1, %BBv0
  ...
  %0 = call i19 @hwtHls.bitConcat.i8.i11(i8 %rxPhi1, i11 -768) #1
  store volatile i19 %0, ptr addrspace(2) %tx, align 4
  ret void
}
