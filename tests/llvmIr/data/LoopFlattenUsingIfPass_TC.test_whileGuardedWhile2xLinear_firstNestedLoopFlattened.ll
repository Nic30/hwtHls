...
bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.22.0 = phi i8 [ undef, %entry ], [ %beginTmp2.22.3, %bb.fn1 ]
...
bb.fn1:                                           ; preds = %bb.wh1.wh.body, %bb.fn1.oldLatch, %bb.wh.wh.body
  %beginTmp2.22.3 = phi i8 [ %beginTmp2.22.1, %bb.wh1.wh.body ], [ %beginTmp2.22.2, %bb.fn1.oldLatch ], [ %beginTmp2.22.0, %bb.wh.wh.body ]
  %beginTmp2.3 = phi i8 [ %beginTmp2.1, %bb.wh.wh.body ], [ %beginTmp2.22.2, %bb.fn1.oldLatch ], [ poison, %bb.wh1.wh.body ]
  ...
  %v2.1.inLatch = phi i8 [ %v3.1, %bb.wh1.wh.body ], [ %v4, %bb.fn1.oldLatch ], [ %v3, %bb.wh.wh.body ]
  %isChildLoopInLatch.bb.wh1.wh = phi i1 [ true, %bb.wh1.wh.body ], [ true, %bb.fn1.oldLatch ], [ true, %bb.wh.wh.body ]
  br label %bb.wh
