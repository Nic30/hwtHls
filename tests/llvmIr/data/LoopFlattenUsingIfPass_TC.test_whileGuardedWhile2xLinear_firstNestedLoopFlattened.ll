...
bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.22.0 = phi i8 [ %beginTmp2.22.1, %bb.fn1 ], [ undef, %entry ]
  %isChildLoop.bb.wh1.wh = phi i1 [ %isChildLoopInLatch.bb.wh1.wh, %bb.fn1 ], [ false, %entry ]
  %beginTmp2.0 = phi i8 [ %beginTmp2.37, %bb.fn1 ], [ undef, %entry ]
  %isChildLoop.bb.wh.wh = phi i1 [ %isChildLoopInLatch.bb.wh.wh8, %bb.fn1 ], [ false, %entry ]
...
bb.wh.wh:                                         ; preds = %bb.wh.wh.preheader, %bb.wh.split1
  %beginTmp2.1 = phi i8 [ %beginTmp, %bb.wh.wh.preheader ], [ %beginTmp2.0, %bb.wh.split1 ]
...
bb.wh1.wh:                                        ; preds = %bb.wh, %bb.wh1.wh.preheader
  %beginTmp2.22.3 = phi i8 [ %beginTmp2.22.0, %bb.wh ], [ %beginTmp2.2, %bb.wh1.wh.preheader ]
...
bb.fn1.oldLatch:                                  ; preds = %bb.fn1.loopexit, %bb.wh1.if
  %beginTmp2.22.2 = phi i8 [ %beginTmp2.22.3, %bb.fn1.loopexit ], [ %beginTmp2.2, %bb.wh1.if ]
  %v4 = phi i8 [ %v2.1.lcssa, %bb.fn1.loopexit ], [ %v1.1, %bb.wh1.if ]
...
bb.fn1.oldLatch6:                                 ; preds = %bb.wh.wh.body, %bb.fn1.oldLatch
  %beginTmp2.22.4 = phi i8 [ %beginTmp2.22.0, %bb.wh.wh.body ], [ %beginTmp2.22.2, %bb.fn1.oldLatch ]
...
bb.fn1:                                           ; preds = %bb.wh1.wh.body, %bb.fn1.oldLatch6
  %beginTmp2.22.1 = phi i8 [ %beginTmp2.22.3, %bb.wh1.wh.body ], [ %beginTmp2.22.4, %bb.fn1.oldLatch6 ]
