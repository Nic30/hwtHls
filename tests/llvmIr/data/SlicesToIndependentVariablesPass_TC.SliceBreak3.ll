define void @SliceBreak3.mainThread(ptr addrspace(1) %i, ptr addrspace(2) %o) !hwtHls.io !0 {
bb0:
  br label %block0

block0:                                           ; preds = %bb0
  %i_read = alloca i32, align 4, !hwtHls.tmp.alloca !3
  store i32 undef, ptr %i_read, align 4
  %i1 = alloca i32, align 4, !hwtHls.tmp.alloca !3
  ...
  %x0 = alloca i32, align 4, !hwtHls.tmp.alloca !3
  store i32 undef, ptr %x0, align 4
  store i32 %i_read3, ptr %x0, align 4
  %x1 = alloca i32, align 4, !hwtHls.tmp.alloca !3
  ...
  %x2 = alloca i32, align 4, !hwtHls.tmp.alloca !3
