...
define void @noDepsSyncBeginEnd(ptr addrspace(1) %dataOut0, ptr addrspace(2) %threadBeginSync.noDepsSyncBeginEnd.t1, ptr addrspace(3) %threadEndSync.noDepsSyncBeginEnd.t1.loc) !prof !0 !hwtHls.io !1 {
bb0:
...
threadSplitCodeRepl:                              ; preds = %bb.mainLoop.threadSplit.begint1
  store volatile i1 true, ptr addrspace(2) %threadBeginSync.noDepsSyncBeginEnd.t1, align 1
  %threadEndSync.noDepsSyncBeginEnd.t1.reload = load volatile i1, ptr addrspace(3) %threadEndSync.noDepsSyncBeginEnd.t1.loc, align 1
...
define internal void @noDepsSyncBeginEnd.t1(ptr addrspace(1) %dataOut1, ptr addrspace(2) %threadBeginSync.noDepsSyncBeginEnd.t1.i, ptr addrspace(3) %threadEndSync.noDepsSyncBeginEnd.t1.o) #0 !hwtHls.io !5 {
threadEntry:
...
bb.mainLoop:                                      ; preds = %newFuncRoot
  %0 = load volatile i1, ptr addrspace(2) %threadBeginSync.noDepsSyncBeginEnd.t1.i, align 1
  store volatile i8 1, ptr addrspace(1) %dataOut1, align 1
  %threadEndSync.noDepsSyncBeginEnd.t1 = freeze i1 true
  store volatile i1 %threadEndSync.noDepsSyncBeginEnd.t1, ptr addrspace(3) %threadEndSync.noDepsSyncBeginEnd.t1.o, align 1
