...
bb.latch:                                         ; preds = %bb1, %bb.c3, %bb.c2
  %0 = phi i3 [ poison, %bb1 ], [ 0, %bb.c3 ], [ 3, %bb.c2 ]
  %1 = select i1 %fewExitSw.sucSel.en.bb1.bb.latch, i3 2, i3 %c0
  %swCond.phi = select i1 %fewExitSw.sucSel.en.bb1.bb.c2, i3 %0, i3 %1
