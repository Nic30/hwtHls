...
bb1:                                              ; preds = %bb.latch, %bb0
  ...
  %fewExitSw.sucSel.en.bb1.bb.c3.noE0 = icmp eq i3 %c0, 3
  %fewExitSw.sucSel.en.bb1.bb.c2 = icmp eq i3 %c0, 2
  %br.bb.c3.noE0.enFor.bb.latch = and i1 %fewExitSw.sucSel.en.bb1.bb.c3.noE0, true
  %br.bb.c0.enFor.bb.latch = and i1 %fewExitSw.sucSel.en.bb1.bb.c0, true
  %fewExitSw.sucSel.en.bb1.bb.latch = icmp eq i3 %c0, 1
  %0 = select i1 %br.bb.c0.enFor.bb.latch, i3 %c0, i3 0
  %1 = select i1 %fewExitSw.sucSel.en.bb1.bb.latch, i3 2, i3 %0
  ...
  %5 = xor i1 %fewExitSw.sucSel.en.bb1.bb.c2, true
  %6 = xor i1 %fewExitSw.sucSel.en.bb1.bb.c2, true
...
bb.latch:                                         ; preds = %bb1, %bb.c3, %bb.c2
  %swCond.phi = phi i3 [ %1, %bb1 ], [ 0, %bb.c3 ], [ 3, %bb.c2 ]
