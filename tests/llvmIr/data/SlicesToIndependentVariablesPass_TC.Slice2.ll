define void @Slice2.mainThread(ptr addrspace(1) %i0, ptr addrspace(2) %i1, ptr addrspace(3) %o) !hwtHls.param_addr_width !0 {
bb0:
  br label %block0

block0:                                           ; preds = %bb0
  %i0_read = alloca i1, align 1, !hwtHls.tmp.alloca !2
  store i1 undef, ptr %i0_read, align 1
  %v3 = alloca i1, align 1, !hwtHls.tmp.alloca !2
  ...
  %i1_read = alloca i5, align 1, !hwtHls.tmp.alloca !2
  store i5 undef, ptr %i1_read, align 1
  %v2 = alloca i5, align 1, !hwtHls.tmp.alloca !2
  ...
  %v27 = alloca i2, align 1, !hwtHls.tmp.alloca !2
