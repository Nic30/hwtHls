...
bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.15.0 = phi i8 [ undef, %entry ], [ %beginTmp2.15.3, %bb.fn1 ]
...
bb.wh.wh:                                         ; preds = %bb.wh.split3, %bb.wh.wh.preheader
  %beginTmp2.1 = phi i8 [ %beginTmp2.0, %bb.wh.split3 ], [ %beginTmp, %bb.wh.wh.preheader ]
  %v2 = phi i8 [ %v1, %bb.wh.wh.preheader ], [ %v0, %bb.wh.split3 ]
...
bb.wh1.wh:                                        ; preds = %bb.wh, %bb.wh1.wh.preheader
  %beginTmp2.15.1 = phi i8 [ %beginTmp2.15.0, %bb.wh ], [ %beginTmp2.1, %bb.wh1.wh.preheader ]
...
bb.fn1.oldLatch:                                  ; preds = %bb.wh.if, %bb.wh1.if, %bb.fn1.loopexit
  %beginTmp2.15.2 = phi i8 [ %beginTmp2.15.1, %bb.fn1.loopexit ], [ %beginTmp2.1, %bb.wh1.if ], [ %beginTmp2.15.0, %bb.wh.if ]
  %beginTmp2.2 = phi i8 [ %beginTmp2.15.1, %bb.fn1.loopexit ], [ %beginTmp2.1, %bb.wh1.if ], [ %beginTmp, %bb.wh.if ]
...
bb.fn1:                                           ; preds = %bb.wh1.wh.body, %bb.wh.wh.body, %bb.fn1.oldLatch
  %beginTmp2.15.3 = phi i8 [ %beginTmp2.15.1, %bb.wh1.wh.body ], [ %beginTmp2.15.2, %bb.fn1.oldLatch ], [ %beginTmp2.1, %bb.wh.wh.body ]
  %beginTmp2.3 = phi i8 [ %beginTmp2.1, %bb.wh.wh.body ], [ %beginTmp2.2, %bb.fn1.oldLatch ], [ poison, %bb.wh1.wh.body ]
  %v2.inLatch = phi i8 [ %v3, %bb.wh.wh.body ], [ %v4, %bb.fn1.oldLatch ], [ poison, %bb.wh1.wh.body ]
  %isChildLoopInLatch.bb.wh.wh = phi i1 [ true, %bb.wh.wh.body ], [ false, %bb.fn1.oldLatch ], [ poison, %bb.wh1.wh.body ]
  %v2.1.inLatch = phi i8 [ %v3.1, %bb.wh1.wh.body ], [ %v3, %bb.wh.wh.body ], [ %v4, %bb.fn1.oldLatch ]
