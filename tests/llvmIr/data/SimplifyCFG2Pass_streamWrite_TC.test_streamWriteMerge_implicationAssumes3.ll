...
loop.pkt.read:                                    ; preds = %loop.pkt.lastCheck.2.writesExit, %loop.pkt
  ...
  %3 = call i2 @hwtHls.bitRangeGet.i28.i6.i2.26(i28 %.w0, i6 26) #5
  %4 = call i2 @hwtHls.bitRangeGet.i28.i6.i2.24(i28 %.w0, i6 24) #5
  %5 = call i1 @hwtHls.bitRangeGet.i28.i6.i1.26(i28 %.w0, i6 26) #5
  %6 = call i3 @hwtHls.bitRangeGet.i28.i6.i3.24(i28 %.w0, i6 24) #5
  %7 = call i1 @hwtHls.bitRangeGet.i28.i6.i1.24(i28 %.w0, i6 24) #5
  %8 = call i1 @hwtHls.bitRangeGet.i28.i6.i1.27(i28 %.w0, i6 27) #5
  %9 = call i1 @hwtHls.bitRangeGet.i28.i6.i1.25(i28 %.w0, i6 25) #5
  %prevMaskBit1Impl35 = icmp ule i1 %9, %7
  call void @llvm.assume(i1 %prevMaskBit1Impl35)
  %maskBitNonLastImpl36 = or i1 %8, %9
  call void @llvm.assume(i1 %maskBitNonLastImpl36)
  %prevMaskBit1Impl37 = icmp ule i1 %5, %9
  call void @llvm.assume(i1 %prevMaskBit1Impl37)
  %10 = icmp eq i2 %4, -1
  %prevMaskBitAll1Impl38 = icmp ule i1 %5, %10
  call void @llvm.assume(i1 %prevMaskBitAll1Impl38)
  %maskBitNonLastImpl39 = icmp ne i2 %3, 0
  call void @llvm.assume(i1 %maskBitNonLastImpl39)
  %11 = icmp eq i3 %6, -1
  %maskAll1ifLastImpl40 = or i1 %8, %11
...
loop.pkt.write.1.streamWrite.sinked:              ; preds = %loop.pkt.read
  call void @hwtHls.streamWrite.masked.p2.i16.i2.i1(ptr addrspace(2) %tx, i16 %2, i2 %34, i1 %35) #4
  br label %36
...
loop.pkt.write.2.streamWrite.sinked:              ; preds = %36
  ...
  call void @hwtHls.streamWrite.p2.i8.i1(ptr addrspace(2) %tx, i8 %1, i1 %.231) #4
  br label %loop.pkt.lastCheck.2.writesExit

loop.pkt.lastCheck.2.writesExit:                  ; preds = %loop.pkt.write.2.streamWrite.sinked, %36
  br i1 %8, label %loop.pkt.eof, label %loop.pkt.read
