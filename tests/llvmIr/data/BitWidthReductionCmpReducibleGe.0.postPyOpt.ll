...
loopHeader:                                       ; preds = %blockL70i0_2018, %entry
  ...
  %36 = icmp uge i16 %30, %35
  store volatile i1 %36, ptr addrspace(10) %res_prefix_differentInMiddle, align 1
  br label %blockL70i0_2018

blockL70i0_2018:                                  ; preds = %loopHeader
  br label %loopHeader
}
