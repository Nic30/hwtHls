...
registers:
  ...
  - { id: 21, class: anyregbank, preferred-register: '', flags: [  ] }
  - { id: 22, class: anyregbank, preferred-register: '', flags: [  ] }
...
body:             |
  ...
  bb.1.loopHeader:
    ...
    %20:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %18(s8), %19
    ...
    %25:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %23(s16), %24
    ...
    %28:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %23(s16), %26
    ...
    %31:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %29(s16), %30
    ...
    %33:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %32(s16), %29
    ...
    %36:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %23(s16), %34
    ...
    %38:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %23(s16), %37
    ...
    %40:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %39(s16), %29
    ...
    %42:anyregcls(s1) = HWTFPGA_ICMP intpred(eq), %41(s16), %29
