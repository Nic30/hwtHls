...
bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.24.0 = phi i8 [ undef, %entry ], [ %beginTmp2.24.4, %bb.fn1 ]
  %isChildLoop.bb.wh1.wh = phi i1 [ false, %entry ], [ %isChildLoopInLatch.bb.wh1.wh, %bb.fn1 ]
  %beginTmp2.0 = phi i8 [ undef, %entry ], [ %beginTmp2.39, %bb.fn1 ]
  %isChildLoop.bb.wh.wh = phi i1 [ false, %entry ], [ %isChildLoopInLatch.bb.wh.wh10, %bb.fn1 ]
...
bb.fn1.oldLatch8:                                 ; preds = %bb.fn1.oldLatch, %bb.wh.wh.body
  %beginTmp2.24.3 = phi i8 [ %beginTmp2.24.2, %bb.fn1.oldLatch ], [ %beginTmp2.24.0, %bb.wh.wh.body ]
  %beginTmp2.3 = phi i8 [ %beginTmp2.1, %bb.wh.wh.body ], [ %beginTmp2.24.2, %bb.fn1.oldLatch ]
...
bb.fn1:                                           ; preds = %bb.wh1.wh.body, %bb.fn1.oldLatch8
  %beginTmp2.24.4 = phi i8 [ %beginTmp2.24.1, %bb.wh1.wh.body ], [ %beginTmp2.24.3, %bb.fn1.oldLatch8 ]
  %v2.1.inLatch = phi i8 [ %v3.1, %bb.wh1.wh.body ], [ %v2.inLatch, %bb.fn1.oldLatch8 ]
  %beginTmp2.39 = phi i8 [ poison, %bb.wh1.wh.body ], [ %beginTmp2.3, %bb.fn1.oldLatch8 ]
