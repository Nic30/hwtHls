...
bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.24.0 = phi i8 [ undef, %entry ], [ %beginTmp2.24.3, %bb.fn1 ]
...
bb.wh1.wh:                                        ; preds = %bb.wh, %bb.wh1.wh.preheader
  %beginTmp2.24.1 = phi i8 [ %beginTmp2.24.0, %bb.wh ], [ %beginTmp2.2, %bb.wh1.wh.preheader ]
...
bb.fn1.oldLatch:                                  ; preds = %bb.wh1.if, %bb.fn1.loopexit
  %beginTmp2.24.2 = phi i8 [ %beginTmp2.24.1, %bb.fn1.loopexit ], [ %beginTmp2.2, %bb.wh1.if ]
  %v4 = phi i8 [ %v1.1, %bb.wh1.if ], [ %v2.1.lcssa, %bb.fn1.loopexit ]
  store volatile i8 %v4, ptr addrspace(2) %o, align 1
  store volatile i8 %beginTmp2.24.2, ptr addrspace(2) %o, align 1
  br label %bb.fn1

bb.fn1:                                           ; preds = %bb.wh1.wh.body, %bb.wh.wh.body, %bb.fn1.oldLatch
  %beginTmp2.24.3 = phi i8 [ %beginTmp2.24.1, %bb.wh1.wh.body ], [ %beginTmp2.24.2, %bb.fn1.oldLatch ], [ %beginTmp2.24.0, %bb.wh.wh.body ]
  %beginTmp2.3 = phi i8 [ %beginTmp2.1, %bb.wh.wh.body ], [ %beginTmp2.24.2, %bb.fn1.oldLatch ], [ poison, %bb.wh1.wh.body ]
