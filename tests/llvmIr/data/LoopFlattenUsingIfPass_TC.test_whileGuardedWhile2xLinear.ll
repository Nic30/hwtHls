...
bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.34.0 = phi i8 [ undef, %entry ], [ %beginTmp2.34.1, %bb.fn1 ]
  %isChildLoop.bb.wh1.wh = phi i1 [ false, %entry ], [ %isChildLoopInLatch.bb.wh1.wh, %bb.fn1 ]
  %beginTmp2.0 = phi i8 [ undef, %entry ], [ %beginTmp2.19, %bb.fn1 ]
...
bb.fn1.oldLatch:                                  ; preds = %bb.wh1.if, %bb.fn1.loopexit
  %beginTmp2.34.3 = phi i8 [ %beginTmp2.34.2, %bb.fn1.loopexit ], [ %beginTmp2.3, %bb.wh1.if ]
...
bb.fn1.oldLatch8:                                 ; preds = %bb.fn1.oldLatch, %bb.wh.wh.body
  ...
  %beginTmp2.1 = phi i8 [ %beginTmp2.2, %bb.wh.wh.body ], [ %beginTmp2.34.3, %bb.fn1.oldLatch ]
