define void @test_whileGuardedWhile2xLinear(ptr addrspace(1) %c, ptr addrspace(2) %o, ptr addrspace(3) %i) !prof !0 {
entry:
  br label %bb.wh

bb.wh:                                            ; preds = %bb.fn1, %entry
  %beginTmp2.25.0 = phi i8 [ undef, %entry ], [ %beginTmp2.25.3, %bb.fn1 ]
  ...
  %v0 = phi i8 [ 0, %entry ], [ %v2.19, %bb.fn1 ]
...
bb.wh1.wh:                                        ; preds = %bb.wh, %bb.wh1.wh.preheader
  %beginTmp2.25.1 = phi i8 [ %beginTmp2.2, %bb.wh1.wh.preheader ], [ %beginTmp2.25.0, %bb.wh ]
...
bb.fn1.oldLatch:                                  ; preds = %bb.wh1.if, %bb.fn1.loopexit
  %beginTmp2.25.2 = phi i8 [ %beginTmp2.25.1, %bb.fn1.loopexit ], [ %beginTmp2.2, %bb.wh1.if ]
  %v4 = phi i8 [ %v1.1, %bb.wh1.if ], [ %v2.1.lcssa, %bb.fn1.loopexit ]
  store volatile i8 %v4, ptr addrspace(2) %o, align 1
  store volatile i8 %beginTmp2.25.2, ptr addrspace(2) %o, align 1
  br label %bb.fn1

bb.fn1:                                           ; preds = %bb.wh1.wh.body, %bb.wh.wh.body, %bb.fn1.oldLatch
  %beginTmp2.25.3 = phi i8 [ %beginTmp2.25.0, %bb.wh.wh.body ], [ %beginTmp2.25.1, %bb.wh1.wh.body ], [ %beginTmp2.25.2, %bb.fn1.oldLatch ]
  %beginTmp2.3 = phi i8 [ %beginTmp2.1, %bb.wh.wh.body ], [ %beginTmp2.25.2, %bb.fn1.oldLatch ], [ undef, %bb.wh1.wh.body ]
  ...
  %v2.19 = phi i8 [ %v3.1, %bb.wh1.wh.body ], [ undef, %bb.wh.wh.body ], [ undef, %bb.fn1.oldLatch ]
