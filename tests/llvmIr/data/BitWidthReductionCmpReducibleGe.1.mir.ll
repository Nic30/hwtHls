--- |
  ...
  loopHeader:                                       ; preds = %bb0, %loopHeader
    ...
    store volatile i1 %0, ptr addrspace(17) %res_suffix_aVs0, align 1
    %1 = call i16 @hwtHls.bitConcat.i8.i8(i8 %a_read2, i8 %a_read2) #1
    %2 = call i16 @hwtHls.bitConcat.i8.i8(i8 %b_read2, i8 -1) #1
    %3 = icmp uge i16 %1, %2
    store volatile i1 %3, ptr addrspace(18) %res_suffix_aVsAll, align 1
    %4 = call i16 @hwtHls.bitConcat.i8.i8(i8 %b_read2, i8 %b_read2) #1
    %5 = zext i8 %a_read2 to i16
    %6 = icmp ule i16 %4, %5
    store volatile i1 %6, ptr addrspace(15) %res_suffix_0vsB, align 1
    store volatile i1 %0, ptr addrspace(16) %res_suffix_AllVsB, align 1
    store volatile i1 %0, ptr addrspace(6) %res_prefix_aVs0, align 1
    %7 = call i16 @hwtHls.bitConcat.i8.i8(i8 -1, i8 %b_read2) #1
    %8 = icmp uge i16 %1, %7
    store volatile i1 %8, ptr addrspace(7) %res_prefix_aVsAll, align 1
    %9 = call i16 @hwtHls.bitConcat.i8.i8(i8 0, i8 %a_read2) #1
    %10 = icmp uge i16 %9, %4
    store volatile i1 %10, ptr addrspace(8) %res_prefix_bVs0, align 1
    store volatile i1 %0, ptr addrspace(9) %res_prefix_bVsAll, align 1
    store volatile i1 %0, ptr addrspace(12) %res_prefix_sameInMiddle, align 1
    store volatile i1 false, ptr addrspace(10) %res_prefix_differentInMiddle, align 1
    br label %loopHeader
  }
...
body:             |
  ...
  bb.1.loopHeader:
    ...
    %20:anyregcls(s1) = HWTFPGA_ICMP intpred(uge), %18(s8), %19
    ...
    HWTFPGA_CSTORE %20(s1), %16, 0, 1, 1 :: (volatile store (s1) into %ir.res_suffix_aVs0, addrspace 17)
    %23:anyregcls(s16) = HWTFPGA_MERGE_VALUES %18(s8), %18(s8), 8, 8
    %24:anyregcls(s16) = HWTFPGA_MERGE_VALUES %19(s8), i8 -1, 8, 8
    %26:anyregcls(s1) = HWTFPGA_ICMP intpred(uge), %23(s16), %24
    ...
    %28:anyregcls(s16) = HWTFPGA_MERGE_VALUES %18(s8), i8 0, 8, 8
    %29:anyregcls(s1) = HWTFPGA_ICMP intpred(ule), %27(s16), %28
    HWTFPGA_CSTORE %29(s1), %14, 0, 1, 1 :: (volatile store (s1) into %ir.res_suffix_0vsB, addrspace 15)
    HWTFPGA_CSTORE %20(s1), %15, 0, 1, 1 :: (volatile store (s1) into %ir.res_suffix_AllVsB, addrspace 16)
    HWTFPGA_CSTORE %20(s1), %5, 0, 1, 1 :: (volatile store (s1) into %ir.res_prefix_aVs0, addrspace 6)
    %30:anyregcls(s16) = HWTFPGA_MERGE_VALUES i8 -1, %19(s8), 8, 8
    %31:anyregcls(s1) = HWTFPGA_ICMP intpred(uge), %23(s16), %30
    HWTFPGA_CSTORE %31(s1), %6, 0, 1, 1 :: (volatile store (s1) into %ir.res_prefix_aVsAll, addrspace 7)
    %32:anyregcls(s16) = HWTFPGA_MERGE_VALUES i8 0, %18(s8), 8, 8
    %34:anyregcls(s1) = HWTFPGA_ICMP intpred(uge), %32(s16), %27
    HWTFPGA_CSTORE %34(s1), %7, 0, 1, 1 :: (volatile store (s1) into %ir.res_prefix_bVs0, addrspace 8)
    HWTFPGA_CSTORE %20(s1), %8, 0, 1, 1 :: (volatile store (s1) into %ir.res_prefix_bVsAll, addrspace 9)
    HWTFPGA_CSTORE %20(s1), %11, 0, 1, 1 :: (volatile store (s1) into %ir.res_prefix_sameInMiddle, addrspace 12)
    HWTFPGA_CSTORE i1 false, %9, 0, 1, 1 :: (volatile store (s1) into %ir.res_prefix_differentInMiddle, addrspace 10)
    HWTFPGA_BR %bb.1
