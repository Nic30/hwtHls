...
define void @ThreadExtractIoFsmPass_ir_TC.test_2loopNested(ptr addrspace(1) %rx, ptr addrspace(2) %0, ptr addrspace(3) %1) !prof !0 !hwtHls.io !1 {
bb0:
  br label %bb.L0.head
...
define void @ThreadExtractIoFsmPass_ir_TC.test_2loopNested.ioFsmExtract.tx(ptr addrspace(1) %tx, ptr addrspace(2) %0, ptr addrspace(3) %1) !prof !0 !hwtHls.io !8 {
bb0:
  br label %bb.L0.head
...
!5 = !{!"OUT", i64 0, i64 1, i64 37, ptr @ThreadExtractIoFsmPass_ir_TC.test_2loopNested.ioFsmExtract.tx, i64 1, !6}
!6 = !{!"hwtHls.io.buffercapacity", i64 1}
!7 = !{!"OUT", i64 0, i64 1, i64 75, ptr @ThreadExtractIoFsmPass_ir_TC.test_2loopNested.ioFsmExtract.tx, i64 2, !6}
!8 = distinct !{!9, !10, !11}
!9 = !{!"OUT", i64 0, i64 37, i64 37, ptr null, i64 1, !3}
!10 = !{!"IN", i64 0, i64 1, i64 37, ptr @ThreadExtractIoFsmPass_ir_TC.test_2loopNested, i64 1}
!11 = !{!"IN", i64 0, i64 1, i64 75, ptr @ThreadExtractIoFsmPass_ir_TC.test_2loopNested, i64 2}
