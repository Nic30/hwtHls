...
; predecessors: %bb.0, %bb.1
  ...
  %2:anyregcls(s16) = GENFPGA_CLOAD %0:anyregcls, 0, 1 :: (volatile load (s16) from %ir.i, addrspace 1)
  ...
  GENFPGA_CSTORE %13:anyregcls(s16), %1:anyregcls, 0, 1 :: (volatile store (s16) into %ir.o, addrspace 2)
  G_BR %bb.1
