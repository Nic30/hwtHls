...
loop.pkt.read:                                    ; preds = %loop.pkt.lastCheck.3.writesExit, %loop.pkt
  ...
  %5 = call i1 @hwtHls.bitRangeGet.i37.i7.i1.35(i37 %.w0, i7 35) #5
  %6 = call i1 @hwtHls.bitRangeGet.i37.i7.i1.34(i37 %.w0, i7 34) #5
  %7 = call i4 @hwtHls.bitRangeGet.i37.i7.i4.32(i37 %.w0, i7 32) #5
  %8 = call i1 @hwtHls.bitRangeGet.i37.i7.i1.32(i37 %.w0, i7 32) #5
  %9 = call i1 @hwtHls.bitRangeGet.i37.i7.i1.36(i37 %.w0, i7 36) #5
  %10 = call i1 @hwtHls.bitRangeGet.i37.i7.i1.33(i37 %.w0, i7 33) #5
  %prevMaskBit1Impl46 = icmp ule i1 %10, %8
  call void @llvm.assume(i1 %prevMaskBit1Impl46)
  %maskBitNonLastImpl47 = or i1 %9, %10
  call void @llvm.assume(i1 %maskBitNonLastImpl47)
  %prevMaskBit1Impl48 = icmp ule i1 %6, %10
  call void @llvm.assume(i1 %prevMaskBit1Impl48)
  %maskBitNonLastImpl49 = or i1 %9, %6
  call void @llvm.assume(i1 %maskBitNonLastImpl49)
  %prevMaskBit1Impl50 = icmp ule i1 %5, %6
  call void @llvm.assume(i1 %prevMaskBit1Impl50)
  %11 = or i1 %9, %5
  call void @llvm.assume(i1 %11)
  %12 = icmp eq i4 %7, -1
  %maskAll1ifLastImpl52 = or i1 %9, %12
...
loop.pkt.write.2:                                 ; preds = %loop.pkt.write.2.guard
  call void @hwtHls.streamWrite.p2.i8.i1.i1.p0(ptr addrspace(2) %tx, i8 %2, i1 false, i1 %.233, ptr null) #4
...
loop.pkt.write.3:                                 ; preds = %loop.pkt.write.3.guard
  ...
  call void @hwtHls.streamWrite.p2.i8.i1.i1.p0(ptr addrspace(2) %tx, i8 %3, i1 false, i1 %.239, ptr null) #4
  br label %loop.pkt.lastCheck.3.writesExit

loop.pkt.lastCheck.3.writesExit:                  ; preds = %loop.pkt.write.3, %loop.pkt.write.3.guard
  br i1 %9, label %loop.pkt.eof, label %loop.pkt.read
