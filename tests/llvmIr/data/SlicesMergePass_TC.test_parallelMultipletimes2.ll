define void @test_parallelMultipletimes2(ptr addrspace(1) %i0, ptr addrspace(1) %i1, ptr addrspace(2) %o0, ptr addrspace(2) %o1, ptr addrspace(2) %o2) {
  ...
  store volatile i1 %xor0, ptr addrspace(2) %o2, align 1
  ret void
}
