...
; predecessors: %bb.0, %bb.1
  ...
  GENFPGA_CSTORE i1 true, %3:anyregcls, 0, 1 :: (volatile store (s1) into %ir.res_prefix_0vs1, addrspace 4)
  GENFPGA_CSTORE i1 true, %4:anyregcls, 0, 1 :: (volatile store (s1) into %ir.res_prefix_0vsAll, addrspace 5)
  GENFPGA_CSTORE %12:anyregcls(s1), %7:anyregcls, 0, 1 :: (volatile store (s1) into %ir.res_prefix_sameInMiddle, addrspace 8)
  GENFPGA_CSTORE i1 true, %5:anyregcls, 0, 1 :: (volatile store (s1) into %ir.res_prefix_differentInMiddle, addrspace 6)
  G_BR %bb.1
