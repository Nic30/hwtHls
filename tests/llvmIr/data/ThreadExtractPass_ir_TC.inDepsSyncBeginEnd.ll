...
define void @inDepsSyncBeginEnd(ptr addrspace(1) %i0, ptr addrspace(2) %o0, ptr addrspace(3) %agrInArg, ptr addrspace(4) %t1.threadEndSync.loc) !prof !0 !hwtHls.io !1 {
bb0:
...
define internal void @inDepsSyncBeginEnd.t1(ptr addrspace(1) %o1, ptr addrspace(2) %0, ptr addrspace(3) %t1.threadEndSync.o) #0 !hwtHls.io !6 {
threadEntry:
