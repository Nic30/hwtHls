...
class HwtHlsInstCombinePass_TC(BaseLlvmIrTC):
    ...
    def test_tryReduceOrOfAssumedPredicates(self):
        llvmIr = """\
        ...
        bb0:
          ...
          %3 = call i2 @hwtHls.bitRangeGet.i28.i6.i2.26(i28 %.r0, i6 26) #2
          %4 = call i24 @hwtHls.bitRangeGet.i28.i6.i24.0(i28 %.r0, i6 0) #2
          %5 = call i2 @hwtHls.bitRangeGet.i28.i6.i2.25(i28 %.r0, i6 25) #2
          %prevMaskBit1Impl54 = icmp ule i1 %2, %0
          call void @llvm.assume(i1 %prevMaskBit1Impl54) ; :note: this is required otherwise %2 will get removed and optimization is not performed
          %NonEoFImplMaskBit153 = or i1 %.eof, %0
          call void @llvm.assume(i1 %NonEoFImplMaskBit153)
          %NonEoFImplMaskBit156 = icmp ne i2 %3, 0
          call void @llvm.assume(i1 %NonEoFImplMaskBit156)
          %6 = icmp eq i3 %.mask, -1
          %NonEoFImplMaskAll157 = or i1 %.eof, %6
          call void @llvm.assume(i1 %NonEoFImplMaskAll157)
          %7 = icmp ne i3 %.mask, -1
          %NonMaskImplEof =  or i1 %7, %.eof
          call void @llvm.assume(i1 %NonMaskImplEof)
          %8 = call i3 @hwtHls.bitConcat.i1.i2(i1 true, i2 %5) #2
          %9 = xor i1 %.eof, -1
          %10 = sext i1 %9 to i3
          %.specExit = or i3 %10, %8
          call void @hwtHls.streamWrite.masked.p2.i24.i3.i1.i1(ptr addrspace(2) %tx, i24 %4, i3 %.specExit, i1 false, i1 %.eof) #4
          ret void
        }
        """
        self._test_ll(llvmIr)
