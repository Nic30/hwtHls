...
define void @noDepsSyncNone(ptr addrspace(1) %dataOut0, ptr addrspace(2) %dataOut1) !prof !0 !hwtHls.io !1 {
bb0:
...
!4 = distinct !{!"t1", i1 true, i1 true, i1 true, i1 true, i64 0, i64 0}
