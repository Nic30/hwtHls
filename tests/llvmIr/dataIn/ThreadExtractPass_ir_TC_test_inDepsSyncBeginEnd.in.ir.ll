...
define void @inDepsSyncBeginEnd(ptr addrspace(1) %i0, ptr addrspace(2) %o0, ptr addrspace(3) %o1) !prof !0 !hwtHls.io !1 {
bb0:
...
bb.mainLoop:                                      ; preds = %bb0, %bb.mainLoop
  ...
  call void @hwtHls.thread.split.begin.t1() #1, !hwtHls.thread.section !5
  store volatile i8 %i.v0, ptr addrspace(3) %o1, align 1
  store volatile i8 %i.v1, ptr addrspace(3) %o1, align 1
  call void @hwtHls.thread.split.end.t1() #1, !hwtHls.thread.section !5
  br label %bb.mainLoop
}
...
!5 = distinct !{!"t1", i1 true, i1 false, i1 true, i1 false, i64 0, i64 0}
