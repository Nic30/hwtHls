--- |
  ...
  blockL192i0_192.outer:                            ; preds = %blockL192i0_192_424_c3, %bb0
    %v3.0.ph = phi i16 [ %11, %blockL192i0_192_424_c3 ], [ 0, %bb0 ]
    %v2.0.ph = phi i16 [ %v2.0.ph8, %blockL192i0_192_424_c3 ], [ 0, %bb0 ]
    %v1.0.ph = phi i16 [ %v1.0.ph12, %blockL192i0_192_424_c3 ], [ 0, %bb0 ]
    %v0.0.ph = phi i16 [ %v0.0, %blockL192i0_192_424_c3 ], [ 0, %bb0 ]
    br label %blockL192i0_192.outer7
  
  blockL192i0_192.outer7:                           ; preds = %blockL192i0_192.outer, %blockL192i0_192_424_c2
    %v2.0.ph8 = phi i16 [ %v2.0.ph, %blockL192i0_192.outer ], [ %11, %blockL192i0_192_424_c2 ]
    %v1.0.ph9 = phi i16 [ %v1.0.ph, %blockL192i0_192.outer ], [ %v1.0.ph12, %blockL192i0_192_424_c2 ]
    %v0.0.ph10 = phi i16 [ %v0.0.ph, %blockL192i0_192.outer ], [ %v0.0, %blockL192i0_192_424_c2 ]
    br label %blockL192i0_192.outer11
  
  blockL192i0_192.outer11:                          ; preds = %blockL192i0_192.outer7, %blockL192i0_192_424_c1
    %v1.0.ph12 = phi i16 [ %v1.0.ph9, %blockL192i0_192.outer7 ], [ %11, %blockL192i0_192_424_c1 ]
    %v0.0.ph13 = phi i16 [ %v0.0.ph10, %blockL192i0_192.outer7 ], [ %v0.0, %blockL192i0_192_424_c1 ]
...
body:             |
  bb.0.bb0:
    ...
    dead %31:anyregcls(s16) = HWTFPGA_MUX i16 0
    %3:anyregcls(s16) = HWTFPGA_MUX i16 0
    dead %67:anyregcls(s16) = HWTFPGA_MUX i16 0
    %66:anyregcls(s16) = HWTFPGA_MUX i16 0
  ...
  bb.2.blockL192i0_192:
    ...
    %22:anyregcls(s16) = HWTFPGA_MUX %46(s16), %15(s1), %10(s16), %17(s1), %66(s16), %19(s1), %3(s16)
    ...
    %29:anyregcls(s16) = HWTFPGA_MUX %46(s16), %24(s1), %10(s16), %25(s1), %66(s16), %26(s1), %3(s16)
    %66:anyregcls(s16) = HWTFPGA_ADD %29(s16), i16 1
    dead %68:anyregcls(s16) = HWTFPGA_MUX %10(s16)
    %12:anyregcls(s16) = HWTFPGA_MUX %46(s16)
    %46:anyregcls(s16) = HWTFPGA_MUX %66(s16), %24(s1), %46(s16)
    ...
    %44:anyregcls(s16) = HWTFPGA_MUX %10(s16), %35(s1), %66(s16)
    %65:anyregcls(s1) = HWTFPGA_AND %35(s1), %60(s1)
    %3:anyregcls(s16) = HWTFPGA_MUX %66(s16), %65(s1), %3(s16)
