...
blockL64i0_64:                                    ; preds = %blockL64i0_724, %block0
  ...
  %c_read = alloca i32, align 4, !hwtHls.tmp.alloca !12
  store i32 undef, ptr %c_read, align 4
  %d_read = alloca i32, align 4, !hwtHls.tmp.alloca !12
  ...
  %x_read = alloca i32, align 4, !hwtHls.tmp.alloca !12
  store i32 undef, ptr %x_read, align 4
  %y_read = alloca i32, align 4, !hwtHls.tmp.alloca !12
  store i32 undef, ptr %y_read, align 4
  %z_read = alloca i32, align 4, !hwtHls.tmp.alloca !12
  store i32 undef, ptr %z_read, align 4
  %w_read = alloca i32, align 4, !hwtHls.tmp.alloca !12
  store i32 undef, ptr %w_read, align 4
  %x1 = alloca i32, align 4, !hwtHls.tmp.alloca !12
  ...
  %y1 = alloca i32, align 4, !hwtHls.tmp.alloca !12
  ...
  %z1 = alloca i32, align 4, !hwtHls.tmp.alloca !12
  ...
  %w1 = alloca i32, align 4, !hwtHls.tmp.alloca !12
