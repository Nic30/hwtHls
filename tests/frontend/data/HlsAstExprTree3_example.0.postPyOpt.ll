...
blockL64i0_64:                                    ; preds = %blockL64i0_724, %block0
  %a_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  store i32 undef, ptr %a_read, align 4
  %b_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  store i32 undef, ptr %b_read, align 4
  %c_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  store i32 undef, ptr %c_read, align 4
  %d_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  ...
  %x_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  store i32 undef, ptr %x_read, align 4
  %y_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  store i32 undef, ptr %y_read, align 4
  %z_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  store i32 undef, ptr %z_read, align 4
  %w_read = alloca i32, align 4, !hwtHls.tmp.alloca !2
  ...
  %y1 = alloca i32, align 4, !hwtHls.tmp.alloca !2
  ...
  %z1 = alloca i32, align 4, !hwtHls.tmp.alloca !2
  ...
  %w1 = alloca i32, align 4, !hwtHls.tmp.alloca !2
