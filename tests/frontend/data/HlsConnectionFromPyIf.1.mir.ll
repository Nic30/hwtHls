--- |
  ...
  define void @HlsConnectionFromPyIf.mainThread(ptr addrspace(1) %i, ptr addrspace(2) %o) !hwtHls.io !0 {
  bb0:
...
...
---
name:            HlsConnectionFromPyIf.mainThread
alignment:       1
...
body:             |
  bb.0.bb0:
    ...
    %4:anyregcls(s1) = HWTFPGA_ICMP intpred(ne), %2(s8), i8 2
    %8:anyregcls(s1) = HWTFPGA_NOT %4(s1)
    HWTFPGA_CSTORE i8 3, %1, 0, 8, %8(s1) :: (volatile store (s8) into %ir.o, addrspace 2)
    HWTFPGA_RET
...
