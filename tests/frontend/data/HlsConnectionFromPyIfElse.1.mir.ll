--- |
  ...
  define void @HlsConnectionFromPyIfElse.mainThread(ptr addrspace(1) %i, ptr addrspace(2) %o) !hwtHls.param_addr_width !0 {
  bb0:
    %i_read1 = load volatile i8, ptr addrspace(1) %i, align 1
    %0 = icmp eq i8 %i_read1, 2
    %1 = xor i1 %0, true
    %2 = call i8 @hwtHls.bitConcat.i1.i2.i1.i4(i1 %0, i2 1, i1 %1, i4 0) #1
    store volatile i8 %2, ptr addrspace(2) %o, align 1
    ret void
  }
...
...
---
name:            HlsConnectionFromPyIfElse.mainThread
alignment:       1
