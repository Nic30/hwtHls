--- |
  ...
  define void @HlsPythonPreprocFor.mainThread(ptr addrspace(1) %o) !hwtHls.io !0 {
  bb0:
...
...
---
name:            HlsPythonPreprocFor.mainThread
alignment:       1
...
body:             |
  bb.0.bb0:
    ...
    HWTFPGA_CSTORE i8 3, %0, 0, 8, 1 :: (volatile store (s8) into %ir.o, addrspace 1)
    HWTFPGA_CSTORE i8 4, %0, 0, 8, 1 :: (volatile store (s8) into %ir.o, addrspace 1)
    HWTFPGA_RET
