...
blockL14i0_14:                                    ; preds = %blockL14i0_408, %block0
  %swap_read = alloca i1, align 1, !hwtHls.tmp.alloca !2
  store i1 undef, ptr %swap_read, align 1
  %swap1 = alloca i1, align 1, !hwtHls.tmp.alloca !2
  ...
  %i1_read = alloca i8, align 1, !hwtHls.tmp.alloca !2
  store i8 undef, ptr %i1_read, align 1
  %i11 = alloca i8, align 1, !hwtHls.tmp.alloca !2
