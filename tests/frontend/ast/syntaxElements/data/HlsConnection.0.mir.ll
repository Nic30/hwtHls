...
; predecessors: %bb.0, %bb.1
  ...
  %2:anyregcls(s32) = GENFPGA_CLOAD %0:anyregcls(s1), 1 :: (volatile load (s32) from %ir.a)
  GENFPGA_CSTORE %2:anyregcls(s32), %1:anyregcls(s1), 1 :: (volatile store (s32) into %ir.b)
  G_BR %bb.1
