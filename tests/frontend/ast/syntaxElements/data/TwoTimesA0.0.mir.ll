# Machine code for function t0_TwoTimesA_TC_test0__TwoTimesA0: NoPHIs, TracksLiveness, Legalized, RegBankSelected, Selected
Frame Objects:
  fi#0: size=1, align=1, at location [SP+2]
  fi#1: size=1, align=1, at location [SP+2]

bb.0.t0_TwoTimesA_TC_test0__TwoTimesA0:
  successors: %bb.1(0x80000000); %bb.1(100.00%)


bb.1.t0_TwoTimesA_TC_test0__TwoTimesA0_whC:
...
# End machine code for function t0_TwoTimesA_TC_test0__TwoTimesA0.
