...
; predecessors: %bb.0, %bb.1
  ...
  %3:anyregcls(s8) = GENFPGA_CLOAD %0:anyregcls, 0, 1 :: (volatile load (s8) from %ir.dataIn, addrspace 1)
  ...
  GENFPGA_CSTORE %4:anyregcls(s8), %1:anyregcls, 0, %10:anyregcls(s1) :: (volatile store (s8) into %ir.dataOut, addrspace 2)
