...
bb.0.t0_HlsAstWhileIf_TC_test_WhileAndIf4_ll__WhileAndIf4:
  ...
  %10:anyregcls(s8) = GENFPGA_MUX i8 10
...
; predecessors: %bb.0, %bb.1
  ...
  %4:anyregcls(s8) = G_SUB %10:anyregcls, %3:anyregcls
  %6:anyregcls(s1) = G_ICMP intpred(uge), %4:anyregcls(s8), i8 5
  %10:anyregcls(s8) = GENFPGA_MUX %4:anyregcls(s8)
  %11:anyregcls(s1) = GENFPGA_NOT %6:anyregcls(s1)
  GENFPGA_CSTORE %4:anyregcls(s8), %1:anyregcls, 0, %11:anyregcls(s1) :: (volatile store (s8) into %ir.dataOut, addrspace 1)
  %10:anyregcls(s8) = GENFPGA_MUX %4:anyregcls(s8), %11:anyregcls(s1)
  G_BR %bb.1
