...
; predecessors: %bb.0, %bb.1
  ...
  %2:anyregcls(s16) = GENFPGA_CLOAD %0:anyregcls, 0, 1 :: (volatile load (s16) from %ir.a)
  %3:anyregcls(s32) = GENFPGA_MERGE_VALUES %2:anyregcls(s16), i16 16, 16, 16
  GENFPGA_CSTORE %3:anyregcls(s32), %1:anyregcls, 0, 1 :: (volatile store (s32) into %ir.b, addrspace 1)
  G_BR %bb.1
