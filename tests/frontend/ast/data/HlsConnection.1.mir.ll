...
; predecessors: %bb.0, %bb.1
  ...
  %2:anyregcls(s32) = GENFPGA_CLOAD %0:anyregcls, 0, 1 :: (volatile load (s32) from %ir.a, addrspace 1)
  GENFPGA_CSTORE %2:anyregcls(s32), %1:anyregcls, 0, 1 :: (volatile store (s32) into %ir.b, addrspace 2)
  G_BR %bb.1
