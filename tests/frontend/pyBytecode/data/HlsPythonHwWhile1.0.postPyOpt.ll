...
blockL20i0_20:
  %4 = phi <Bits, 8bits, unsigned> [<BitsVal 0>, block0], [<BitsVal 0>, blockL20i0_60]
  br [label %blockL20i0_L22i0_22 ]
blockL20i0_L22i0_22:
  %1 = phi <Bits, 8bits, unsigned> [%4, blockL20i0_20], [%2, blockL20i0_L22i0_58]
  void call <Bits, 8bits, unsigned> @hls.write(i)
  %2 = ADD %1, <BitsVal 1>
  i_rst3 = call <Bits, 1bit> @hls.read(i_rst)
  br [label %blockL20i0_56 i_rst3]
  [label %blockL20i0_L22i0_58 ]
blockL20i0_56:
